...
We include a list of [instructions](https://github.com/nbfigueroa/franka_interactive_controllers/blob/main/doc/instructions/README.md) for using the franka panda arm with this controller package:
